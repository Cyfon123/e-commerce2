        ...
        <Grid container sx ={{justifyContent:'space-between'}}>
                ...
                <div className='h-auto shadow-lg bg-white p-5 sticky top-5'>
                    ...
                    <div className='space-y-4 mt-10'>
                        ...
                        {orderStatus.map((item)=> <div className='flex items-center'>
                            <input defaultValue={item.value} type='checkbox' className='h-4 w-4 border-gray-300 text-indigo-600 focus:ring-indigo-500'/>
            ...
            <Grid item xs={9}>
                <div className='space-y-5'>
                    {[1,1,11,1,,1,1,1,1,1,1].map((item)=><OrderCard/>)}
                </div>
